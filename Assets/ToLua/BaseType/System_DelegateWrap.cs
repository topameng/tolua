...
public class System_DelegateWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("CreateDelegate", new LuaCSFunction(CreateDelegate));
		L.RegFunction("DynamicInvoke", new LuaCSFunction(DynamicInvoke));
		L.RegFunction("Clone", new LuaCSFunction(Clone));
		L.RegFunction("GetObjectData", new LuaCSFunction(GetObjectData));
		L.RegFunction("GetInvocationList", new LuaCSFunction(GetInvocationList));
		...
		L.RegVar("Method", new LuaCSFunction(get_Method), null);
